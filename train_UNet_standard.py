import argparse
from models import GeneralUNet
...
def main(args):
    ...
    train_set = SigSepDataset(filepaths_list[:num_train_files], standard_scaler, dtype='real')
    val_set = SigSepDataset(filepaths_list[num_train_files:], standard_scaler, dtype='real')
