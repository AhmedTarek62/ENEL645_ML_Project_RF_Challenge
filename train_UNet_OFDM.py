...
from comm_utils import demodulate_ofdm_signal
from comm_utils import create_resource_grid
...
def main(args):
    ...
    def demodulator(x):
        rg = create_resource_grid(512)
        return demodulate_ofdm_signal(x, resource_grid=rg)
